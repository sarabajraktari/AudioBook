...
<div class="m-auto w-4/5 py-10">
    ...
    <div class=" flex max-w-md  bg-gray-100 rounded-md shadow-md overflow-hidden mb-7  md:max-w-6xl">
            ...
            <div class="md:flex ">
                <div class="p-4 flex-shrink w-64 h-30  ">
                    <img class=" md:w-40 h-40 object-cover " src="{{ asset('images/' . $book->image_path) }}" >
                </div> 
        ...
        <div class="sm:grid  justify-items-end  w-1/2  grid  content-center mr-10  ">
            <div>
            <a 
